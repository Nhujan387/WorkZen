...
<div class="containeremp">
    ...
    <h1 class="bannertextstyle12">Edit Your Application</h1>
        ...
        <div class="job-viewport">
            ...
            while ($result = mysqli_fetch_assoc($runquery)) {
                ...
                <div>
                <a href="deapply.php?j_id=<?php echo $jid;?>&e_id=<?php echo $eid;?>&a_id=<?= $_GET['a_id'] ;?>"><button style="background-color:red;color:white;font-size:22px;border-radius:5px;width:144px;">CEASE</button></a>
                </div>
                </div>
                <?php
            }
